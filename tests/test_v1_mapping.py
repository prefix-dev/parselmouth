...
table = RelationsTable.from_conda_to_pypi_index(index, SupportedChannels.CONDA_FORGE)
...
print(f"   ✓ Compressed size: {len(table_data):,} bytes ({len(table_data)/1024/1024:.1f} MB)")
